...
import com.mycompany.quanlinhasach.dao.BaoCaoTonKhoDAO;
...
public class TonKho extends javax.swing.JPanel {
     ...
     */
    private BaoCaoTonKhoDAO baoCaoTonKhoDAO;
    private DefaultTableModel tblModel;
    private DecimalFormat formatter = new DecimalFormat("#,###");
    
    public TonKho() {
        initComponents();
        baoCaoTonKhoDAO = new BaoCaoTonKhoDAO();
...
public final void initTable() {
    ...
    String[] headerTbl = new String[]{"Mã báo cáo", "Tên sách", "Tồn đầu", "Tồn cuối", "Phát sinh"};
...
public void loadDataToTable() {
        try {
            List<BaoCaoTonKho> baoCaoList = baoCaoTonKhoDAO.getAllBaoCaoTonKho();
            tblModel.setRowCount(0);

            for (BaoCaoTonKho bc : baoCaoList) {
                tblModel.addRow(new Object[]{
                    bc.getMaBaoCaoTonKho(),
                    bc.getTenSach(),
                    formatter.format(bc.getTonDau()),
                    formatter.format(bc.getTonCuoi()),
...
public void loadComboBoxData() {
    List<Integer> months = baoCaoTonKhoDAO.getDistinctMonths();
    List<Integer> years = baoCaoTonKhoDAO.getDistinctYears();
...
private void searchByMonthYearAndName(Integer month, Integer year, String name) {
    ...
    List<BaoCaoTonKho> list = baoCaoTonKhoDAO.getBaoCaoTonKhoByMonthYearAndName(month, year, name);
    for (BaoCaoTonKho bc : list) {
        tblModel.addRow(new Object[]{
            bc.getMaBaoCaoTonKho(),
            bc.getTenSach(),
            formatter.format(bc.getTonDau()),
    ...
    private void initComponents() {
        ...
        jTextFieldsearch.setText("Tìm kiếm sách");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tên sách", "Tồn đầu", "Phát sinh", "Tồn cuối"
            }
        ) {
    ...
    private void jTextFieldsearchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldsearchFocusGained
        // TODO add your handling code here:
        if (jTextFieldsearch.getText().equals("Tìm kiếm sách")) {
...
String fileName = "TonKho.xlsx";
if (month != null) {
    fileName = "TonKho_Thang_" + month + ".xlsx";
}
if (year != null) {
    fileName = "TonKho_Nam_" + year + ".xlsx";
}
if (month != null && year != null) {
    fileName = "TonKho_Thang_" + month + "_Nam_" + year + ".xlsx";
}
...
if (userSelection == JFileChooser.APPROVE_OPTION) {
    ...
    try (Workbook workbook = new XSSFWorkbook()) {
        ...
        if (month != null || year != null || (name != null && !name.isEmpty())) {
            ...
            if (name != null && !name.isEmpty() && !name.equals("Tìm kiếm sách")) {
                filterInfo.append("Tên sách: ").append(name).append(" ");
            }
